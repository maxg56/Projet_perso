...
init_item "Obsidian"  "Obsidian.Obsidian"

init_item "Python 3.13.0a2" "Python.Python.3.13"

init_item "Python Launcher"   "Python.Launcher"

init_item "Python 3.11.5 (64-bit)"   "  Python.Python.3.11 "

init_item "NZXT CAM " "NZXT.CAM"

init_item "Google Drive"  "Google.GoogleDrive" 

init_item "Microsoft 365 Apps for enterprise"  "Microsoft.Office" 

init_item "NVIDIA GeForce Experience" "Nvidia.GeForceExperience"

init_item "ProtonVPN  "  "ProtonTechnologies.ProtonVPN" 

init_item "DaVinci Resolve" "3AF5FB42-AA97-4582-B73C-8185234B7FFC"

init_item "Paradox Launcher v2"  " ParadoxInteractive.ParadoxLauncher"
...
if ($global:install) {
    ...
    if ($installPackages.count -ne 0) {
        ...
        foreach ($package in $installPackages) {
            & winget install -e --id $package --accept-package-agreements --accept-source-agreements --force -h
...
# Exécuter la commande WinGet pour mettre à jour toutes les applications
